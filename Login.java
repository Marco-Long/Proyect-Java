...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("admin".equals(usuario)&&"admin".equals(pass)){
            ...
            for(Alumno a : Loginb.alumnos){
                if(a.usuario.equals(usuario)&&a.password.equals(pass)){
                    Loginb.alumnologeado = a;
                    BienvenidaUsuario A = new BienvenidaUsuario();
                    A.setVisible(true);
                    encontrado = true;                    
                    this.dispose();
                    break;
 ...
 if(!encontrado){
                JOptionPane.showMessageDialog(this, "Usurio U Password incorrecto.");
            }
    }
    }
